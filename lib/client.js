window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function ResultBar({ state, t, onRestore, onClose }) {
		  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "dshce-card", "data-dshce": "result", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "dshce-body", children: [
